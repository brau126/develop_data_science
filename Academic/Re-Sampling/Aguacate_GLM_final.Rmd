...
base_aguacate <- readxl::excel_sheets("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/datos/base_aguacate.xlsx")
...
for (k in base_aguacate) {
  base_list[[k]] <- readxl::read_excel("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/datos/base_aguacate.xlsx",
                                    sheet = k)
}
...
df_deaths <- readr::read_csv("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/datos/ucdp_deaths_violence.csv", show_col_types = FALSE)
...
![]("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/imagenes/produccion_aguacate_serie.png"){width='500px'}
...
![]("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/imagenes/produccion_aguacate_mapa.png"){width='500px'}
...
![]("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/imagenes/perdida_siembra_mapa.png"){width='500px'}
...
![]("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/imagenes/perdida_siembra_top_estado.png"){width='500px'}
...
![]("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/imagenes/muertes_por_estado_carteles.png"){width='500px'}
...
![]("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/imagenes/agresiones_civiles_mapa.png"){width='500px'}
...
![]("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/imagenes/Top_Estados_Agreder_Civiles.png"){width='500px'}
...
![]("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/imagenes/michoacan_aguacate_y_muertes.png"){width='500px'}
...
![]("D:/Documentos_D/0uni/fac_escuela/Modelos_Sim/Aguacate/imagenes/michoacan_perdida_y_muertes.png"){width='500px'}
...
Facilitar el análisis de múltiples factores de crimen organizado que afectan a la producción de los productores de aguacate,tras haber complementado con la información necesaria de estorsiones, derechos de piso, desapariciones, entre otros.

- Segmetación de Datos

Reconocer la influencia que tienen los factores de violencia sobre las pérdidas en la producción, para delimitar zonas de riesgo y ajustar el valor de la prima con valores de sobre cargo dependiendo ubicación de la producción. Dicha clusterización se deja para el sigueinte parcial pues como se comenta en la sección 4.5. hay autores que en estudios previos resaltan que la presencia de desaparición de personas también es un indicador importante de presencia y presión de crimen organizado, entre otros factores, por lo que es necesario complementar la información.
...
- Análisis de Estrés de la Prima Pura de Riesgo
...
$$
\log(\mu_i) = \beta_0 + \beta_1\,\text{índice_crim}_i + \beta_2\,\text{volumenproduccion}_i + \beta_3\,\text{Precio}_i + \beta_4\,\text{Valorproduccion}_i
$$
